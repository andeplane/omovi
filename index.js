...
var ComboControls = _interopDefault(require('@cognite/three-combo-controls'));
var Stats = _interopDefault(require('stats.js'));
...
var inverseModelMatrix = new THREE.Matrix4();
var modelViewMatrix = new THREE.Matrix4();
var normalMatrix = new THREE.Matrix3();
var inverseNormalMatrix = new THREE.Matrix3();
...
var Visualizer = function Visualizer(domElement) {
  ...
  this.resizeIfNeeded = function () {
    ...
    var rendererSize = _this.renderer.getSize(new THREE.Vector2());
...
var Particles = /*#__PURE__*/function () {
  function Particles(capacity) {
    ...
    this.getPosition = function (index) {
      return new THREE.Vector3(_this.positions[3 * index + 0], _this.positions[3 * index + 1], _this.positions[3 * index + 2]);
    };
    ...
    this.getGeometry = function () {
      var baseGeometry = new THREE.PlaneBufferGeometry(1, 1, 1, 1);
      ...
      geometry.setAttribute('particlePosition', new THREE.InstancedBufferAttribute(_this.positions, 3, false, 1));
      geometry.setAttribute('particleRadius', new THREE.InstancedBufferAttribute(_this.radii, 1, false, 1));
      return geometry;
    };
    ...
    this.getMesh = function () {
      ...
      _this.mesh = new THREE.InstancedMesh(geometry, material, _this.count);
...
var Bonds = /*#__PURE__*/function () {
  function Bonds(capacity) {
    ...
    this.getPosition1 = function (index) {
      return new THREE.Vector3(_this.positions1[3 * index + 0], _this.positions1[3 * index + 1], _this.positions1[3 * index + 2]);
    };
    ...
    this.getGeometry = function () {
      ...
      positions.push(1, 1, 1);
      positions.push(1, -1, 1);
      var positionBufferAttribute = new THREE.BufferAttribute(new Float32Array(positions), 3);
      var indexBufferAttribute = new THREE.BufferAttribute(new Uint16Array([1, 2, 0, 1, 3, 2, 3, 4, 2, 3, 5, 4]), 1);
      var geometry = new THREE.InstancedBufferGeometry();
      geometry.instanceCount = _this.count;
      ...
      geometry.setAttribute('position1', new THREE.InstancedBufferAttribute(_this.positions1, 3, false, 1));
      geometry.setAttribute('position2', new THREE.InstancedBufferAttribute(_this.positions2, 3, false, 1));
      geometry.setAttribute('bondRadius', new THREE.InstancedBufferAttribute(_this.radii, 1, false, 1));
      return geometry;
    };
...
var SimulationDataFrame = function SimulationDataFrame(particles, simulationCell) {
  ...
  this.generateSimulationCell = function () {
    ...
    var origin = box.getCenter(new THREE.Vector3()).sub(size.clone().multiplyScalar(0.5));
    var simulationCell = new SimulationCell(new THREE.Vector3(size.x, 0, 0), new THREE.Vector3(0, size.y, 0), new THREE.Vector3(0, 0, size.x), origin);
...
exports.Bonds = Bonds;
exports.OMOVIVisualizer = OMOVIVisualizer;
exports.Particles = Particles;
exports.SimulationData = SimulationData;
exports.SimulationDataFrame = SimulationDataFrame;
exports.createBondsByDistance = createBondsByDistance;
