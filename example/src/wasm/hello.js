...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_array')) {
        Object.defineProperty(Module['ready'], '_array', { configurable: true, get: function() { abort('You are getting _array on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_array', { configurable: true, set: function() { abort('You are setting _array on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var FSNode = /** @constructor */ function(parent, name, mode, rdev) {
  ...
  FS.FSNode = FSNode;
  FS.staticInit();Module["FS_createDataFile"] = FS.createDataFile;;
var ASSERTIONS = true;
...
/** @type {function(...*):?} */
var _array = Module["_array"] = createExportWrapper("array");
